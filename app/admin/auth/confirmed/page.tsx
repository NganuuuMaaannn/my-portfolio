  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md rounded-2xl border border-slate-700 bg-slate-800 p-8 text-center">
        <h1 className="text-2xl font-semibold text-slate-50">Confirmation successful</h1>
        <p className="mt-3 text-sm leading-6 text-slate-300">
          Your email has been confirmed successfully. This tab will try to close
          automatically in 5 seconds. If it stays open, continue to the admin dashboard.
        </p>
        <Link
          href="/admin"
