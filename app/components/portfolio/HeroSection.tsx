  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center">
        <span className="inline-flex w-fit rounded-full border border-teal-300/20 bg-teal-300/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-teal-200 shadow-sm">
          Dummy portfolio landing page
        </span>
        <h1 className="mt-8 max-w-3xl text-5xl font-semibold leading-tight text-slate-50 sm:text-6xl lg:text-7xl">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-3">
          {heroStats.map((stat) => (
            <div
              key={stat.label}
              className="rounded-[28px] border border-white/10 bg-white/6 px-5 py-6 shadow-[0_18px_50px_rgba(2,6,23,0.28)] backdrop-blur"
            >
