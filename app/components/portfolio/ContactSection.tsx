    ...
    >
      <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {contactMethods.map((item) => {
            ...
            return (
              <a
                ...
                className="rounded-[30px] border border-white/10 bg-slate-900/66 p-6 shadow-[0_18px_60px_rgba(2,6,23,0.36)] transition hover:-translate-y-1 hover:border-teal-300/30"
              >
          ...
          <div className="rounded-[30px] border border-dashed border-orange-300/15 bg-orange-400/10 p-6 sm:col-span-2">
